...
async function main(params) {
  ...
  try {
    ...
    const requiredParams = ["sandboxName", "apiKey", "schemaId"];
    ...
    const apiEndpoint = `https://platform.adobe.io/data/foundation/schemaregistry/tenant/schemas/${params.schemaId}`;
