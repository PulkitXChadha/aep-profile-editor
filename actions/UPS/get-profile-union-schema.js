...
async function main(params) {
  ...
  try {
    ...
    const apiEndpoint = `https://platform.adobe.io/data/foundation/schemaregistry/tenant/unions/_xdm.context.profile__union`;
    ...
    // put
    // await state.put(`${params.sandboxName}-profile-union-schema`, content, {
    //   ttl: 60,
    // });

    // write private file
    await files.write(
      `${params.sandboxName}/profile-union-schema.json`,
    ...
    const response = {
      statusCode: 200,
      body: {
        message: "profile schema updated",
        key: `${params.sandboxName}/profile-union-schema.json`,
        link: presignUrl,
      },
    };
